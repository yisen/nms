...
<body>
	...
	<input id="dev_id" type="hidden" name="dev_id" value="<?php echo $dev_id;?>">
	<input id="dev_rw" type="hidden" name="dev_rw" value="<?php echo $dev_info->rwcommunity;?>">
	<input id="dev_ro" type="hidden" name="dev_ro" value="<?php echo $dev_info->rocommunity;?>">
		<div class="snmp_top_menu">
			<table cellspacing="10px" style="width: 900px;">
				<tr>
					<td class="snmp_add_cell">
					<input id="ipaddr" type="text" name="ipaddr" class="snmp_add_input" style="width: 150px; font-size: 13px;"
						value="">
					</td>
					<td class="snmp_add_cell">
